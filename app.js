...
function renderOverviewGrid(stats) {
  ...
  const statusColor = { ontime: '#1D9E75', late: '#EF9F27', critical: '#E24B4A', alert: '#F97316' };
  const statusLabel = { ontime: 'No prazo', late: 'Atrasado', critical: 'Crítico', alert: 'Em alerta' };
  const statusIcon  = { ontime: 'ti-circle-check', late: 'ti-clock-exclamation', critical: 'ti-alert-triangle', alert: 'ti-bell-exclamation' };
